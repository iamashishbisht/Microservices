...
* The original package name 'com.example.microservices.netflix-zuul-api-gateway-server' is invalid and this project uses 'com.example.microservices.netflixzuulapigatewayserver' instead.
