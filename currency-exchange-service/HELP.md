...
* The original package name 'com.example.miroservices.currency-exchange-service' is invalid and this project uses 'com.example.miroservices.currencyexchangeservice' instead.
